...
public class Drake extends Enemy {
    ...
    private int attackValue = 45;

    private Random random = new Random();

    private boolean boss = false;

    public Drake(int currentHp, int maxHp) {
    ...
    public void die() {
        this.sprite = new Sprite(new Texture(Gdx.files.internal("deadDrake.png")));
    ...
    public void attack(Hero hero) {
        ...
        int nextDamageValue = random.nextInt(10) + 40;
        this.setAttackValue(nextDamageValue);
