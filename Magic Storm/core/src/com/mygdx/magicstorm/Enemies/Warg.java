...
//Attack value continually increases in combat
public class Warg extends Enemy {
    private Sprite sprite = new Sprite(new Texture(Gdx.files.internal("warg.png")));
    ...
    private int attackValue = 24;

    private boolean boss = false;

    public Warg(int currentHp, int maxHp) {
    ...
    public void die() {
        this.sprite = new Sprite(new Texture(Gdx.files.internal("deadWarg.png")));
    ...
    public void attack(Hero hero) {
        ...
        setAttackValue(this.attackValue += 5);
